...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'hello_requests', (
            ...
            ('req_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('method', self.gf('django.db.models.fields.CharField')(default='', max_length=30)),
            ('status', self.gf('django.db.models.fields.IntegerField')(default='', max_length=30)),
        ))
    ...
    models = {
        ...
        u'hello.requests': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'method': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30'}),
            'path': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'req_time': ('django.db.models.fields.DateTimeField', [], {}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': "''", 'max_length': '30'})
        }
    }
